...
export default function SavedScreen() {
  ...
  return (
    <>
      <Helmet>
        <title>Saved Deals – Your Favourites | OffferHop</title>
        <meta name="description" content="Your saved food and drink deals from OffferHop. Quick-access your favourite BOGO offers, happy hours and restaurant discounts." />
        <link rel="canonical" href="https://offerhop.in/saved" />
      </Helmet>
